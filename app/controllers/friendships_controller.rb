class FriendshipsController < ApplicationController
	...
	def create
		...
		if @seeded_users.include? @target_user.id 
			...
			Notification.create!(user: current_user, from: @target_user, content: "accepted your friend request! You are now friends!", topic: "friend")
			...
			Notification.create!(user: @target_user, from: current_user, content: "sent you a friend request!", topic: "friend")
	...
	def update
		...
		Friendship.create!(user: current_user, friend: @target_user, accepted: true)
		Notification.create!(user: @target_user, from: current_user, content: "accepted your friend request! You are now friends!", topic: "friend")
		flash[:notice] = "Friend added! You are now friends with #{@target_user.name}!" 
		redirect_back(fallback_location: root_url)
	end

class FriendshipsController < ApplicationController
	...
	def create
		...
		Notification.create!(user: @target_user, from: current_user, content: "#{current_user} sent you a friend request!")
	...
	def update
		...
		Notification.create!(user: @target_user, from: current_user, content: "#{current_user} accepted your friend request! You are now friends!")
